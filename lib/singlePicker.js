                    ...
                    <View style={[styles.modalContainer, this.props.style]}>
                        ...
                        <View style={[styles.buttonView, this.props.headerStyle]}>
                            <TouchableOpacity style={[styles.button, styles.buttonLeft]} onPress={() => {
                                ...
                                <Text
                                    style={this.props.buttonCancelStyle}>{this.props.buttonTextCancel ? this.props.buttonTextCancel : 'Cancel'}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.button, styles.buttonRight]} onPress={() => {
                                ...
                                <Text
                                    style={this.props.buttonAcceptStyle}>{this.props.buttonTextConfirm ? this.props.buttonTextConfirm : 'Select'}</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{ backgroundColor: '#CACACA', height: 0.5, width: Dimensions.get('window').width }}/>
